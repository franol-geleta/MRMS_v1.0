<?php $__env->startSection('myPageTitle', 'አዲስ የየቤተሰብ አባል መመዝገቢያ | New Family Member Data'); ?>
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Add Member\'s Family Member Data')); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title"><?php echo e(__('አዲስ የአባሉ የቤተሰብ አባል መመዝገቢያ | Add Member\'s Familiy Member Data')); ?></h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(route ('members.familymember.store', $memberFamilyMember->idMember)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php $__currentLoopData = DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 28)->pluck('list_LookupDataName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="rdoFamilyMemberStatus" id="rdoFamilyMemberStatus_<?php echo e($value); ?>" required>
...
<?php echo $__env->make('layouts.mrmsMainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mrms.semienfgbc.org/resources/views/members/familymember/create.blade.php ENDPATH**/ ?>