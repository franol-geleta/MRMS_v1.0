<?php $__env->startSection('myPageTitle', 'የመኖሪያ አድራሻ ማሳያ | Show Residential Address Data'); ?>
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Show Member\'s Residential Address')); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-8 col-6">
                    <h4 class="page-title"><?php echo e(__('የአባሉ የመኖሪያ አድራሻ ማሳያ | Show Member\'s Residential Address Data')); ?></h4>
                </div>
                <div class="col-2 text-right">
                    <?php if((Auth::user()->role == 'Super Admin' || Auth::user()->role == 'Editor') && Auth::user()->status == 'Active'): ?>
                        <a href="<?php echo e(route ('members.residentialaddress.edit', $member->idResidentialAddressData)); ?>" class="btn btn-warning float-right btn-rounded"><i class="fa fa-edit">&nbsp;&nbsp;&nbsp;</i><strong><?php echo e(__('አስተካክል | Edit')); ?></strong></a>
                    <?php endif; ?>
                </div>
                <div class="col-2 text-right">
...
<?php echo $__env->make('layouts.mrmsMainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mrms.semienfgbc.org/resources/views/members/residentialaddress/show.blade.php ENDPATH**/ ?>