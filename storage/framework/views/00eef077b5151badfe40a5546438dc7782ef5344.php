<?php $__env->startSection('myPageTitle', 'አዲስ የመኖሪያ አድራሻ መመዝገቢያ | New Residence Address Data'); ?>
    ...
    <div class="page-wrapper">
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Add Member\'s Residential Address')); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title"><?php echo e(__('አዲስ የአባሉ የመኖሪያ አድራሻ መመዝገቢያ | Add Member\'s Residential Address Data')); ?></h4>
                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <ul class="personal-info">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="text"><a href="#"><?php echo e(__('N/A')); ?></a></span>
                                                    </li>
                                                    <li>
        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="card-title"><?php echo e(__('የአባሉ የመኖሪያ አድራሻ | Member\'s Residence Address')); ?></h4>
                        <form action="<?php echo e(route ('members.residentialaddress.store', $member->idMember)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbCountry" required>
                                                        ...
                                                        <?php $__currentLoopData = DB::table('sfgbc_Setting_CountryList')->pluck('list_CountryName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php if($value === 'Ethiopia'): ?> <?php echo e($value); ?>" selected <?php else: ?> <?php echo e($value); ?>" <?php endif; ?>><?php echo e($value); ?> </option>
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbProvince" required>
                                                        ...
                                                        <?php $__currentLoopData = DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 5)->pluck('list_LookupDataName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php if($value === 'Addis Ababa'): ?> <?php echo e($value); ?>" selected <?php else: ?> <?php echo e($value); ?>" <?php endif; ?>><?php echo e($value); ?> </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <input type="text" class="form-control floating" name="txtMunicipality" required placeholder="Your City | Town...">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-focus">
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbSubcity" required>
                                                        ...
                                                        <?php $__currentLoopData = DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 6)->pluck('list_LookupDataName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php if($value === 'Gulele'): ?> <?php echo e($value); ?>" selected <?php else: ?> <?php echo e($value); ?>" <?php endif; ?>><?php echo e($value); ?> </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <input type="text" class="form-control floating" name="txtWoreda" required placeholder="Woreda">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <input type="text" class="form-control floating" name="txtHouseNum" placeholder="House Number">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <input type="text" class="form-control floating" name="txtLocationNaming" required placeholder="Location | Place Naming">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <div class="cal-icon">
                                                        <input class="form-control floating" type="tel" name="telePrimaryMobile" required placeholder="Mobile phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    <label class="focus-label"><?php echo e(__('ሞባይል (አማራጭ) | Mobile (Alternate)')); ?></label>
                                                    <div class="cal-icon">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea cols="30" rows="10" class="form-control" name="txaAddressRemarks" placeholder="Please leave your comment regarding the member's address here..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.mrmsMainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mrms.semienfgbc.org/resources/views/members/residentialaddress/create.blade.php ENDPATH**/ ?>