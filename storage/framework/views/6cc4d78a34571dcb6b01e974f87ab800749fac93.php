<?php $__env->startSection('myPageTitle', 'የቤተሰብ አባል መረጃ ማስተካከያ | Edit Family Member\'s Data'); ?>
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"><?php echo e(__('Family Member(s)')); ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Edit Family Member')); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title"><?php echo e(__('የአባሉ የቤተሰብ አባል መረጃ ማስተካከያ | Edit Member\'s Family Member Data')); ?></h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(route ('members.familymember.update', $memberFamilyMember->idFamilyMember)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <input type="hidden" name="hdnMemberID" value="<?php echo e($memberFamilyMember->idMember); ?>">
...
<?php echo $__env->make('layouts.mrmsMainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mrms.semienfgbc.org/resources/views/members/familymember/edit.blade.php ENDPATH**/ ?>