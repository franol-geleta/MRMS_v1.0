                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $newMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newMember): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route ('members.show', $newMember->idMember)); ?>"><button class="btn btn-danger btn-primary-one float-right"><?php echo e(__('Pick')); ?></button></a>
                                                </td>
                                            </tr>
                                        ...
                                        <?php $__currentLoopData = $newMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newMember): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                               <td>
                                                ...
                                                <td><?php echo e($newMember->civilStatus); ?></td>
                                                  <td>
                                                    <a href="<?php echo e(route ('members.show', $newMember->idMember)); ?>"><button class="btn btn-danger btn-primary-one float-right"><?php echo e(__('Take')); ?></button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a style="font-weight: bolder;" href="<?php echo e(route ('members.show', $serviceSectorStaff->idMember)); ?>" title="<?php echo e($serviceSectorStaff->appellation.' '.$serviceSectorStaff->firstName.' '.$serviceSectorStaff->middleName.' '.$serviceSectorStaff->lastName); ?>"><img src="<?php echo e($serviceSectorStaff->photograph); ?>" alt="<?php echo e($serviceSectorStaff->appellation.' '.$serviceSectorStaff->firstName.' '.$serviceSectorStaff->middleName.' '.$serviceSectorStaff->lastName); ?>" class="w-40 rounded-circle"></a>
                                            </div>
                                            <div class="contact-info">
                                                ...
                                                <span class="contact-date"><?php echo e($serviceSectorStaff->roleOnSector.' @ '.$serviceSectorStaff->serviceSectorName); ?></span>
                                            </div>
                                            <div class="contact-info">
...
<?php echo $__env->make('layouts.mrmsMainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mrms/resources/views/dashboard.blade.php ENDPATH**/ ?>