...
@section('myPageTitle', 'የትምህርት ደረጃ ማስተካከያ | Edit Education Level Data')
@section('MainContent')
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Member\'s Education Level') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የትምህርት ደረጃ መረጃ ማስተካከያ | Edit Member\'s Education Level Data') }}</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form action="{{ route ('members.educationlevel.update', $memberEducationLevel->idEducationLevelData) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field ('PUT') }}
