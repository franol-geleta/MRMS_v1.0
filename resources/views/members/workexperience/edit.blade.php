...
@section('myPageTitle', 'የስራ ልምድ መረጃ ማስተካከያ | Edit Work Experience Data')
@section('MainContent')
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Member\'s Work Experience') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የስራ ልምድ መረጃ ማስተካከያ | Edit Member\'s Work Experience Data') }}</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form action="{{ route ('members.workexperience.update', $memberWorkExperience->idWorkExperienceData) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field ('PUT') }}
