...
@section('myPageTitle', 'የህብረት መረጃ ማስተካከያ | Edit Fellowship Data')
@section('MainContent')
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Member\'s Fellowship Data') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የህብረት መረጃ ማስተካከያ | Edit Member\'s Fellowship Data') }}</h4>
                </div>
