...
@section('myPageTitle', 'አዲስ የመኖሪያ አድራሻ መመዝገቢያ | New Residence Address Data')
@section('MainContent')
    <div class="page-wrapper">
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Add Member\'s Residential Address') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('አዲስ የአባሉ የመኖሪያ አድራሻ መመዝገቢያ | Add Member\'s Residential Address Data') }}</h4>
                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <ul class="personal-info">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="text"><a href="#">{{ __('N/A') }}</a></span>
                                                    </li>
                                                    <li>
        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="card-title">{{ __('የአባሉ የመኖሪያ አድራሻ | Member\'s Residence Address') }}</h4>
                        <form action="{{ route ('members.residentialaddress.store', $member->idMember) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field ('POST') }}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-box">
                                        <div class="row">
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbCountry" required>
                                                        ...
                                                        @foreach(DB::table('sfgbc_Setting_CountryList')->pluck('list_CountryName') as $value)
                                                            <option value="@if ($value === 'Ethiopia') {{ $value }}" selected @else {{ $value }}" @endif>{{ $value }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbProvince" required>
                                                        ...
                                                        @foreach(DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 5)->pluck('list_LookupDataName') as $value)
                                                            <option value="@if ($value === 'Addis Ababa') {{ $value }}" selected @else {{ $value }}" @endif>{{ $value }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group form-focus select-focus">
                                                    ...
                                                    <select class="select form-control floating" name="cmbSubcity" required>
                                                        ...
                                                        @foreach(DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 6)->pluck('list_LookupDataName') as $value)
                                                            <option value="@if ($value === 'Gulele') {{ $value }}" selected @else {{ $value }}" @endif>{{ $value }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group form-focus">
                                                    <label class="focus-label">{{ __('ሞባይል (አማራጭ) | Mobile (Alternate)') }}</label>
                                                    <div class="cal-icon">
