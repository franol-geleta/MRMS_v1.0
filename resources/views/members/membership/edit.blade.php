...
@section('myPageTitle', 'የአባልነት መረጃ ማስተካከያ | Edit Membership Data')
@section('MainContent')
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Member\'s Membership Data') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የአባልነት መረጃ ማስተካከያ | Edit Member\'s Membership Data') }}</h4>
                </div>
