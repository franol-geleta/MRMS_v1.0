...
@section('myPageTitle', 'የአባሉ የአገልግሎት ዘርፍ መረጃ ማስተካከያ | Edit Service Sector Data')
@section('MainContent')
    <div class="page-wrapper">
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Member\'s Service Sector Data') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የአገልግሎት ዘርፍ መረጃ ማስተካከያ | Edit Member\'s Service Sector Data') }}</h4>
                </div>
        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="card-title">{{ __('የአባሉ የአገልግሎት ዘርፍ መረጃ | Member\'s Service Sector Data') }}</h4>
                        <form action="{{ route ('members.servicesector.update', $memberServiceSector->idServiceSectorData) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field ('PUT') }}
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" id="srvJoinedDate">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <div class="cal-icon">
                                                        <input type="text" class="form-control floating" name="datSectorJoinedDate" id="SectorJoinedDatePicker" value="{{ $memberServiceSector->joinedDate }}" placeholder="Member's Service Sector Joined Date" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach(DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 26)->pluck('list_LookupDataName') as $value)
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="rdoStillServingHere" id="rdoStillServingHere_{{ $value }}" value="@if ($value === $memberServiceSector->stillServingHere) {{ $value }}" checked @else {{ $value }}" @endif onClick="itemServiceSectorDataVisibility()">
                                            ...
                                            <div class="col-md-4" id="srvLeftDate">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <div class="cal-icon">
                                                        <input type="text" class="form-control floating" name="datSectorLeftDate" id="SectorLeftDatePicker" value="{{ $memberServiceSector->leftServingDate }}" placeholder="Member's Service Sector Left Date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12" id="srvLeftReason">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <input type="text" class="form-control floating" name="txtSectorLeftReason" value="{{ $memberServiceSector->leftServingReason }}" placeholder="Reason to left the service sector">
                                                </div>
                                            </div>
                            ...
                            <input type="hidden" name="hdnMemberID" value="{{ $memberServiceSector->idMember }}">
