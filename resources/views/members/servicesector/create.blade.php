...
@section('myPageTitle', 'የአባሉ የአገልግሎት ዘርፍ መረጃ መመዝገቢያ | Add Service Sector Data')
@section('MainContent')
    <div class="page-wrapper">
            ...
            <div style="text-align: right;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Add Member\'s Service Sector Data') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-sm-10 col-6">
                    <h4 class="page-title">{{ __('የአባሉ የአገልግሎት ዘርፍ መረጃ መመዝገቢያ | Add Member\'s Service Sector Data') }}</h4>
                </div>
        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="card-title">{{ __('የአባሉ የአገልግሎት ዘርፍ መረጃ መመዝገቢያ | Add Member\'s Service Sector Data') }}</h4>
                                                    ...
                                                    <select class="select form-control floating" name="cmbServiceSector" required>
                                                        <option value="">{{ __('Select Service Sector') }}</option>
                                                            ...
                                                            @foreach($valueServiceSectors as $valueServiceSector)
                                                                <option value="{{ $valueServiceSector->serviceSectorType.' | '.$valueServiceSector->sectorStatus }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach(DB::table('sfgbc_Setting_LookupData')->where('list_LookupDataParent', '=', 26)->pluck('list_LookupDataName') as $value)
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="rdoStillServingHere" id="rdoStillServingHere_{{ $value }}" value="{{ $value }}" onClick="itemServiceSectorDataVisibility()">
