        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-sm-6 offset-lg-1">
                    <h4 class="page-title">{{ __('Add Lookup Data Value') }}</h4>
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <form id="newLookupDataForm" action="{{ route ('setting.systemvariable.slookupdata', 1) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="focus-label">{{ __('Lookup Data Type') }} <span class="text-danger"> {{ __(' *') }}</span></label>
                                    <select class="select form-control" name="cmbLookupDataType" required>
                                        <option value="">{{ __('Select Lookup Data Type') }}</option>
                                        @foreach(DB::table('sfgbc_Setting_LookupData')->distinct()->pluck('list_LookupDataType') as $value)
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="focus-label">{{ __('Lookup Data Name') }} <span class="text-danger"> {{ __(' *') }}</span></label>
                                    <select class="select form-control" name="cmbLookupDataName" required>
                                        <option value="">{{ __('Select Lookup Data Name') }}</option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>{{ __('Lookup Data Description') }} <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text">
                                </div>
                            </div>
                        </div>
